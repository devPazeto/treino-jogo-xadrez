...
// https://stackoverflow.com/questions/2979383/java-clear-the-console
	...
	public static PosicaoXadrez lerPosicaoUsuario (Scanner sc) {
		...
		return new PosicaoXadrez(coluna, linha);
			...
			throw new InputMismatchException("Erro ao instanciar a posição no xadrez. Posições válidas de a1 ate h8 ");
		}
	}
	...
	private static void printPeca(PecaDeXadrez peca, boolean planoDeFundo) {
	 	if(planoDeFundo) {
